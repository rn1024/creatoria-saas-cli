...
### 使用模板创建新项目
```bash
# 在任意工作目录下，使用 cra create 脚手架
cra create my-saas-app \
  --db-host localhost \
  --db-port 5432 \
...
# 跳过安装依赖
cra create my-saas-app --skip-install
```
...
- GitHub: https://github.com/creatoria/@creatoria/cli
...
# 提交 Issue
# https://github.com/creatoria/@creatoria/cli/issues
```
